...
void testAll() { 
	...
	SortedSet sf(r2);
	assert(sf.add(5) == true);
	assert(sf.add(1) == true);
	assert(sf.add(10) == true);
	assert(sf.add(7) == true);
	assert(sf.add(-3) == true);

	SortedSetIterator itf = sf.iterator();
	itf.first();
	try {
		itf.jumpForward(-12);
		assert(false);
